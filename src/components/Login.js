...
const Login = () => {
  ...
  return (
    <div>
      ...
      <form className='absolute w-3/12 p-8 bg-black my-36 mx-auto right-0 left-0 text-white rounded-lg bg-opacity-80'>
        ...
        <input type='text' placeholder='Password' className='p-2 my-2 w-full bg-gray-700'/>
        <button className='p-4 my-2 bg-red-700 w-full rounded-md'>{isSignInForm ? "Sign In" : "Sign Up"}</button>
